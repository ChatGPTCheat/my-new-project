...
float GetPitch(float Fov) 
{
    if (Fov > 75 && Fov <= 130) return 0.6f * NumIo[14];
    else if (Fov == 70 || Fov == 75 || Fov == 55 || Fov == 60) return 2.5f * NumIo[14];
    else {
        switch ((int)Fov) {
            case 44: return 5.1f * NumIo[14];
            case 26: return 7.1f * NumIo[14];
            case 20: return 8.4f * NumIo[14];
            case 13: return 13.9f * NumIo[14];
            default: return 2.5f * NumIo[14]; // 8倍
        }
    }
}
