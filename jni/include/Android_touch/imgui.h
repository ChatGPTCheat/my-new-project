...
namespace ImGui
{
	...
	IMGUI_API bool          ButtonTextColored(const ImVec4& col, const char* fmt, ...)      IM_FMTARGS(2);
   ...
   IMGUI_API bool          RadioButton(const char* label, float* v, float v_button);
	...
	IMGUI_API ImVec2        CountTextSize(const ImFont* font, const char* text, float font_size);
